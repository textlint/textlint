...
function Config(options) {
    ...
    this.formatName = options.formatName ? options.formatName : defaultOptions.formatName;
}
/**
...
Config.initWithCLIOptions = function (cliOptions) {
    ...
    options.formatName = cliOptions.format ? cliOptions.format : defaultOptions.formatName;
